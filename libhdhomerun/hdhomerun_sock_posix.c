...
static int hdhomerun_local_ip_info_getifaddrs(struct hdhomerun_local_ip_info_t ip_info_list[], int max_count)
{
...
static int hdhomerun_local_ip_info_ioctl(struct hdhomerun_local_ip_info_t ip_info_list[], int max_count)
{
...
#else
    return hdhomerun_local_ip_info_ioctl(ip_info_list, max_count);
#endif
}
